...
- Does **not** collect device identifiers, advertising identifiers, or usage analytics
- Does **not** access your contacts, photos, camera, microphone, or other device features unless explicitly required for core functionality, and in that case, no data from these features is stored or transmitted off your device
...
We may update this Privacy Policy from time to time, for example to reflect changes in the App's functionality. If the App's data practices change, we will update this policy and revise the "Last Updated" date above. We encourage you to review this page periodically.
...
**Email:** jtserafin+support@gmail.com


---

*This policy applies solely to the App and does not apply to any third-party websites, services, or applications that may be linked to or from the App.*
